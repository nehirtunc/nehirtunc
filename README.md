...
* **Programlama Dilleri:** Java, Python, Dart, JavaScript, MIPS Assembly
* **Web & Arka Uç (Backend):** Flask, RESTful API Tasarımı, HTML5, CSS3
* **Sistem & Veritabanı:** Buildroot (Gömülü İşletim Sistemleri), İlişkisel Veritabanı Yönetimi ve Optimizasyonu (3NF Normalizasyonu)
* **Prensipler & Odak Alanları:**, Mobil Uygulama Geliştirme, Sistem Programlama, Web Arayüzü Mimarisi, Nesne Yönelimli Programlama (OOP)
...
Profesyonel işbirlikleri, uzun dönem staj programları veya teknik fikir alışverişleri için bana ulaşabilirsiniz:

* **LinkedIn:** [Nehir Tunç](https://www.linkedin.com/in/nehir-tunc/)
* **E-posta:** [nehirtunc38@gmail.com](mailto:nehirtunc38@gmail.com)
